class CognitoAuth {
  ...
  login() {
    ...
    const loginUrl = `https://${cognitoDomain}/login?` + `client_id=${clientId}&` + `response_type=${responseType}&` + `scope=${scope}&` + `redirect_uri=${encodeURIComponent(redirectUri)}`;
  ...
  signup() {
    ...
    const signupUrl = `https://${cognitoDomain}/signup?` + `client_id=${clientId}&` + `response_type=${responseType}&` + `scope=${scope}&` + `redirect_uri=${encodeURIComponent(redirectUri)}`;
